...
def validate_ingestion(**context):
    ...
    Checks that both tax sales and foreclosures were loaded.
    """
...
with DAG(
    ...
    description='Daily ingestion of tax sales and foreclosures from ArcGIS APIs',
    ...
    # Task 3: Validate ingestion (runs after both complete)
    ...
    # Define dependencies
    # Tax sales and foreclosures run in parallel, then validation
